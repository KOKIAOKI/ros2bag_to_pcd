...
def generate_launch_description():
  ...
  ros2bag_to_pcd = launch_ros.actions.Node(package='ros2bag_to_pcd', executable='online', output='screen', parameters=[{"lidar_topic_name":lidar_topic_name},{"output_pcd_folder":output_pcd_folder}])
